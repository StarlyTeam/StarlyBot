package kr.starly.discordbot.rank.repository;
...
import kr.starly.discordbot.coupon.requirement.impl.DayAfterVerifyRequirement;
import kr.starly.discordbot.coupon.requirement.impl.RoleRequirement;
...
import kr.starly.discordbot.rank.perk.impl.CouponPerk;
import kr.starly.discordbot.rank.perk.impl.PreReleasePerk;
import kr.starly.discordbot.rank.perk.impl.RolePerk;
...
public class RankRepository {
    ...
    public static void $initialize() {
        ...
        final long RANK1_ROLE_ID = Long.parseLong(configProvider.getString("VERIFIED_ROLE_ID"));
        ...
        rank2.addPerk(new RolePerk(RANK4_ROLE_ID));
        ...
        rank2.addPerk(new RolePerk(RANK5_ROLE_ID));
